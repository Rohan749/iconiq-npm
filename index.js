...
var IcoInput = exports.IcoInput = function IcoInput(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, type !== "password" ? /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "ico_input"
  }, startIcon ? startIcon : icon, /*#__PURE__*/_react["default"].createElement("input", _extends({
    value: value,
...
var IcoFormControl = exports.IcoFormControl = function IcoFormControl(_ref2) {
  ...
  var mappedData = entries.map(function (val, index) {
    ...
    }, passAlert && /*#__PURE__*/_react["default"].createElement("div", null, val.type === "name" && !isValidName(val.value.data) ? "Please enter your name" : "", val.type === "password" && !isValidPassword(val.value.data) ? "Password length must be more than 5 characters" : "", val.type === "url" && !isValidUrl(val.value.data) ? "Entered url is invalid." : "", val.type === "date" && !isValidDOBFormat(val.value.data) ? "Please enter date in format of dd/mm/yyyy" : "", val.type === "twitter" && !isValidUrl(val.value.data) ? "Invalid twitter link." : "", val.type === "linkedin" && !isValidUrl(val.value.data) ? "Invalid linkedin link" : "", val.type === "github" && !isValidUrl(val.value.data) ? "Invalid github link" : "", val.type === "medium" && !isValidUrl(val.value.data) ? "Invalid medium link" : "", val.type === "instagram" && !isValidUrl(val.value.data) ? "Invalid instagram link" : "", val.type === "email" && !isValidEmail(val.value.data) ? "Entered email is invalid" : "")));
  });
